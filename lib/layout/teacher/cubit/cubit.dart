...
import '../../../modules/teacher/add_note/add_note_screen.dart';
...
*/
  ...
  void getClasses() {
    ...
    FirebaseFirestore.instance.collection('Teachers').doc(userID).collection('Community').get().then(
      (value) {
value.docs.forEach((element) {
      FirebaseFirestore.instance.collection('Countries').doc(Tcountry).collection('Schools').doc(Tschool).collection('SchoolStaff').doc(element['uid']).get().then((value2){
classes.addAll(value2['classes']);
      });
